...
export function setSeo(seo = {}) {
  ...
  /* OPEN GRAPH */
  if (title) setTag('meta[property="og:title"]', "og:title", title);
  if (description) setTag('meta[property="og:description"]', "og:description", description);
  setTag('meta[property="og:url"]', "og:url", canonical);
  setTag('meta[property="og:type"]', "og:type", "website");
  setTag('meta[property="og:image"]', "og:image", ogImage);

  /* TWITTER */
  setTag('meta[name="twitter:card"]', "twitter:card", "summary_large_image");
  if (title) setTag('meta[name="twitter:title"]', "twitter:title", title);
  if (description) setTag('meta[name="twitter:description"]', "twitter:description", description);
